        ...
        <div className="mx-auto max-w-[100rem] px-8 md:px-12">
          <div className="relative min-h-[360px] md:min-h-[500px] border border-black/10 overflow-hidden">
            ...
            <div
              ...
              style={{ backgroundImage: "url('/images/cnc-press-brake-forming/squarespace-03.jpg')" }}
            />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-black/10 border border-black/10">
            {capabilities.map((cap, i) => (
              <motion.div 
                ...
                className="bg-[#f5f5f5] p-8 md:p-12 flex flex-col justify-between min-h-[300px] group hover:bg-white transition-colors"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-px bg-white/10 border border-white/10">
            {materials.map((mat, i) => (
              <motion.div 
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.8, delay: i * 0.1 }}
                className="bg-[#0a0a0a] p-10 md:p-16 flex flex-col justify-between min-h-[300px] group hover:bg-[#111] transition-colors"
              >
